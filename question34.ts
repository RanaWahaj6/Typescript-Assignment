...
• Add a line at the end of your program, outside the for loop, that states
 ...
 let Pizzas=["BBQ ","Cheese","Pepperoni"]
 ...
 for (let i = 0; i < Pizzas.length; i++) {
    console.log("I love the "+Pizzas[i]+" Pizza most.")
    
 }


 console.log("I like different kinds of pizza.")
console.log("Some of my favorites include Cheese, Pepperoni, and BBQ .")
console.log("Pizza is one of the best food inventions ever.")
